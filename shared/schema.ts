...
export const outlets = pgTable("outlets", {
  ...
  currencySymbol: varchar("currency_symbol", { length: 10 }).default("د.إ"),
  currencyName: varchar("currency_name", { length: 50 }).default("UAE Dirham"),
  ...
  timezone: varchar("timezone", { length: 100 }).default("UTC"),
    ...
    outletTaxRate: decimal("outlet_tax_rate", { precision: 5, scale: 2 }).default("5"),
...
export const cashSessions = pgTable("cash_sessions", {
  ...
  currencyCode: varchar("currency_code", { length: 10 }).notNull().default("AED"),
  currencySymbol: varchar("currency_symbol", { length: 10 }).default("د.إ"),
...
export const outletTipSettings = pgTable("outlet_tip_settings", {
  ...
  currencyCode: varchar("currency_code", { length: 10 }).default("AED"),
  currencySymbol: varchar("currency_symbol", { length: 5 }).default("د.إ"),
