    ...
    <div className="min-h-screen p-6 bg-background">
      ...
      <div className="max-w-3xl mx-auto py-8" id="main-content">
        ...
        <div className="prose prose-sm max-w-none space-y-4 text-sm leading-relaxed">
          <p>
            These Terms of Service describe the agreement between Table Salt and the restaurant operators, staff, and
            end customers who use the platform.
          </p>
          <p>
            This page is a placeholder. The full Terms of Service are being prepared and will be published before public
            launch.
          </p>
          ...
          <p>
            ...
            <a href="mailto:support@inifinit.com" className="text-primary hover:underline" data-testid="link-terms-contact">
