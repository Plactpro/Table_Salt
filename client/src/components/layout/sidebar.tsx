...
const navItems: NavItem[] = [
  ...
  { id: "m-23", name: "Suppliers", icon: BookOpen, path: "/suppliers", roles: ["owner", "franchise_owner", "hq_admin", "manager", "outlet_manager"], featureKey: "inventory" },
  { id: "m-24", name: "Procurement", icon: ShoppingCart, path: "/procurement", roles: ["owner", "franchise_owner", "hq_admin", "manager", "outlet_manager"], featureKey: "inventory" },
  { id: "m-25", name: "Workforce", icon: HardHat, path: "/workforce", roles: ["owner", "franchise_owner", "hq_admin", "manager", "outlet_manager"], featureKey: "staff" },
  { id: "m-9", name: "Staff", icon: Users, path: "/staff", roles: ["owner", "franchise_owner", "hq_admin", "manager", "outlet_manager"], featureKey: "staff" },
  { id: "m-10", name: "Reports", icon: BarChart3, path: "/reports", roles: ["owner", "franchise_owner", "hq_admin", "manager", "outlet_manager", "accountant", "auditor"], featureKey: "reports" },
  ...
  { id: "m-14", name: "Performance", icon: TrendingUp, path: "/performance", roles: ["owner", "franchise_owner", "hq_admin", "manager", "outlet_manager"], featureKey: "staff" },
  { id: "m-15", name: "Delivery", icon: Truck, path: "/delivery", roles: ["owner", "franchise_owner", "hq_admin", "manager", "outlet_manager"], featureKey: "delivery_management" },
  { id: "m-21", name: "Online Orders", icon: ShoppingBag, path: "/orders-hub", roles: ["owner", "franchise_owner", "hq_admin", "manager", "outlet_manager"], featureKey: "delivery_management" },
  { id: "m-22", name: "HQ Console", icon: Building2, path: "/hq-console", roles: ["owner", "franchise_owner", "hq_admin"], featureKey: "outlets" },
  { id: "m-27", name: "Audit Log", icon: ScrollText, path: "/audit-log", roles: ["owner", "franchise_owner", "hq_admin", "manager", "outlet_manager", "accountant", "auditor"], featureKey: "reports" },
  { id: "m-28", name: "Security", icon: Shield, path: "/security", roles: ["owner", "franchise_owner", "hq_admin"], featureKey: "settings" },
