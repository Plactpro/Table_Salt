...
| Q-083 | 9 | Q-080 partially answered (2026-04-30): Railway Pro plan upgrade enables manual snapshot capability. First manual snapshot taken 2026-04-30 07:00 UTC, 149 MB incremental. Scheduled/automated snapshots, documented restore procedure, and formal RPO/RTO are still NOT configured. | See `audit/incident-2026-04-30-railway-pro-upgrade.md`. |
