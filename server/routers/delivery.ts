        ...
        `SELECT o.id, o.tenant_id, o.order_number, o.customer_name, o.customer_phone,
         ...
         WHERE o.tenant_id = $1
           ...
           AND o.status NOT IN ('paid', 'completed', 'voided')
                       AND (o.channel_order_id IS NULL OR NOT EXISTS (SELECT 1 FROM order_channels oc WHERE oc.name = o.order_type::text AND oc.tenant_id = o.tenant_id AND oc.active = false))
